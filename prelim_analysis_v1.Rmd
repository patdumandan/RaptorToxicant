...
### Part 1: Overall Toxicant Exposure  
**Proportion exposed to toxicants** 
...
* build beta regression model with intercepts allowed to vary per study, fixed effects of species, toxicant type,sample type, and geographical region (maybe traits too?) 
...
tox_prop3=rbind(tox_prop1, tox_prop2)

length(unique(tox_prop$ID)) #16 studies that reported sample size and exposure
