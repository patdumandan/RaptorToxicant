...
tox_dat=read.csv("https://raw.githubusercontent.com/patdumandan/RaptorToxicant/main/full_dataset.csv")
...
ks.test(fr_tox_dat$BodyMass.Value, global_sp_dat$BodyMass.Value)  #D=0.10, p=0.97
